<div>
	<div class="item-center flex justify-between">
		...
		<div class="flex cursor-pointer justify-end" wire:click="$dispatch('openModal', { component: 'recipe-modal' })">
		...
		@foreach ($recipes as $recipe)
			<div class="flex items-center justify-between border-b-2 py-3 last:border-b-0">
				...
				<div class="inline-flex-1 min-w-max text-sm">
					<div wire:click="$dispatch('openModal', { component: 'recipe-modal', arguments: {recipe: {{ $recipe }}} })"
						class="flex cursor-pointer items-center justify-end mb-2">
					...
					<div wire:click="delete({{ $recipe->id }})" wire:confirm="{{ __("Are you sure you want to delete this recipe?") }}"
						class="flex cursor-pointer justify-end text-xs text-red-500 hover:text-red-700">
